...
import moblieAppsIcon from '../assets/mobileIcon.svg';
                ...
                <Grid container justify="flex-end" alignItems="center" direction="row">
                    <Grid sm item className={classes.heroTextContainer}>
                        <Typography variant="h2" align="center">
                            Brinfinf West Coast Technology <br/> 
                            to the Midwest
                        </Typography>
                        <Grid 
                            container 
            ...
            <Grid item>
                ...
                >
                    <Grid item style={{ textAlign: matchesSM ? "center" : undefined }}>
                        <Typography variant="h4">
                            iOS/Adroid App Development
                        </Typography>
                        <Typography variant="subtitle1" className={classes.subtitle}>
                            Extend Functionality. Extend Access. Increase Engagment.
                        </Typography>
                        <Typography variant="subtitle1">
                            Intergeate your web experience or create a standalone
                            app{matchesSM ? null : <br />} with either mobile platform.
                        </Typography>
                        <Button 
                            component={Link} to="/moblieapps"
                            variant="outlined" 
                            className={classes.learnButton}
                        ...
                        >
                            <Grid container direction="column">
                                ...
                                <Typography variant="subtitle2">
                                    Say hello.
                                    <span role="img" aria-label="waving hand">hand</span>
                                </Typography>
                                <Grid item>
                                    <Button 
